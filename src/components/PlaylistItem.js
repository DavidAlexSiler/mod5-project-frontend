        ...
        return (
            <div>
                <Item className='playlist-item'>
                    ...
                    <Item.Content className='playlist-item-content'>
                ...
                {this.state.clicked && this.state.playlistDetails.items ? <PlaylistDetails details={this.state.playlistDetails} name={name}/> :
                null}
            </div>
        )
